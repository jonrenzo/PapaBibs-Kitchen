            ...
            <div class="w-64 border-r border-gray-200 p-4">
                <div class="mb-6">
                    ...
                    <nav class="flex flex-col space-y-3">
                        ...
                        <a class="py-1 flex items-center gap-2 text-gray-700 hover:text-red-500  {{ request()->routeIs('user.account.orders') ? 'text-red-500 bg-red-50 font-medium' : 'text-gray-700 font-normal' }} px-3 py-2 rounded-md" href="{{ route('user.account.orders', ['user' => auth()->id()]) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
