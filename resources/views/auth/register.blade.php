    ...
    <div class="max-w-full relative">
        ...
        <div class="absolute top-1/2 right-[15%] transform -translate-y-1/2 w-full max-w-[500px] bg-white p-8 rounded-[40px] shadow-lg z-10">
            ...
            <form method="POST" action="/register">
                ...
                <div class="max-w-full">
                    <div class="relative">
                        <x-form-input id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm Password" required></x-form-input>
                        <button type="button" data-hs-toggle-password='{"target": "#password_confirmation"}' class="absolute top-0 right-0 h-14 flex items-center justify-center z-20 px-3 cursor-pointer text-gray-400 rounded-e-md focus:outline-hidden focus:text-blue-600">
                            <svg class="size-5 inline-flex text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.933 13.909A4.357 4.357 0 0 1 3 12c0-1 4-6 9-6m7.6 3.8A5.068 5.068 0 0 1 21 12c0 1-3 6-9 6-.314 0-.62-.014-.918-.04M5 19 19 5m-4 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                            </svg>
                ...
                <button type="submit" class="w-full bg-red-600 text-white p-3 rounded-full font-semibold hover:bg-red-700 transition duration-300 mt-2">Register</button>
