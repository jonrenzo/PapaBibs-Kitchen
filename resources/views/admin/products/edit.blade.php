...
<x-admin-layout>
    <h1>Edit Product : <span class="text-bibs-red font-bold">{{ $products->name }}</span></h1>

    <!-- Card Section -->
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <form method="POST" action="/admin/products/{{ $products->id }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <!-- Card -->
                ...
                <div class="pt-0 p-4 sm:pt-0 sm:p-7">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            @if ($products->image_location)
                                <div class="mb-2">
                                    <img src="{{ asset('/' . $products->image_location) }}" alt="Current Image" class="max-w-xs rounded-md border border-gray-300 h-20" />
                                </div>
                            @endif
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea
                                id="description"
                                name="description"
                                class="py-1.5 sm:py-2 px-3 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                rows="6"
                    ...
                    <div class="mt-5 flex justify-center gap-x-2">
                        <a href="/admin/products/" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-bibs-red text-white hover:bg-red-800 focus:outline-hidden focus:bg-red-800  disabled:opacity-50 disabled:pointer-events-none">
                            Cancel
                        </a>
